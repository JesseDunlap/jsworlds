 ...
 *
 * @param		int x 		The X coordinate (represented in tiles, not pixels)
 * @param		int y 		The Y coordinate (represented in tiles, not pixels)
 * @param 		int layer 	The layer on which the tile should be added, which comes from Map.TileLayer, or a custom integer level.
 * @param 		int tile 	The tile ID which should exist at the specified location.
 *
