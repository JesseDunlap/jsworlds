...
/**
 * Sets the attribute at ID
 */
Map.prototype.setAttribute = function(x, y, attribute) {
	this.attributes[x]			= this.attributes[x] || [];
	this.attributes[x][y]		= this.attributes[x][y] || [];
	this.attributes[x][y]		= attribute;

	this.socket.emit("changed-attribute", { map: this, x: x, y: y, attribute: attribute });
};
